...
sidebarTitle: "Universal Data Graph"
...
- [How to secure the data graph](/api-management/data-graph#security)
...
Head over to the [connect data source](/api-management/data-graph#udg) section to learn about the supported data sources and how to connect them to Tyk.
...
* [UDG Arguments](/api-management/data-graph#arguments)
* [UDG Datasources](/api-management/data-graph#udg)
...
See [Concept: Arguments](/api-management/data-graph#arguments) to learn more about it.
 ```
...
Global headers now have access to all [request context variables](/api-management/traffic-transformation#request-context-variables).
...
Data source headers now have access to all [request context variables](/api-management/traffic-transformation#request-context-variables).
...
Above steps are explained in detail in our [Getting started pages](/api-management/data-graph#connect-datasource).
...
You can learn more about it [here](/#udg)
...
To learn more about arguments click [here](/#arguments)

To learn more about reusing response fields click [here](/#reusing-response-fields)
...
You can learn more about field mapping [here](/#field-mappings)
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/lRLLFLv2rN4" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> 
...
We offer 3 ways of importing an example into Tyk:
 - Using [tyk-sync](/api-management/automations/sync#synchronize-api-configurations-with-github-actions)
 - Manually import via [Dashboard API Import](/api-management/gateway-config-managing-classic#import-an-api)
- Using Tyk Dashboard to browse and import the examples directly

#### Import via tyk-sync

Please follow the [tyk-sync documentation](/api-management/automations/sync#examples-publish-command) to learn more about this approach.
...
You can find more detailed instructions in the [Dashboard API Import documentation section](/api-management/gateway-config-managing-classic#import-an-api).
