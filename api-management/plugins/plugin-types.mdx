...
- [Go custom authentication plugin](/api-management/automations/operator#custom-plugin-auth-go)
- [gRPC custom authentication plugin](/api-management/automations/operator#custom-plugin-auth-grpc)
...
and provides a [Virtual Endpoint](/api-management/traffic-transformation#virtual-endpoints-overview) style capability using the Go language, rather than JavaScript (as supported by the virtual endpoint middleware).
...
This plugin allows you to add custom logic to the processing flow for the specific endpoint without adding to the processing complexity of other endpoints.
It can [terminate the request](/api-management/plugins/golang#terminating-the-request), if required,
and hence can provide a [Virtual Endpoint](/api-management/traffic-transformation#virtual-endpoints-overview) style capability using the Go language, rather than JavaScript (as supported by the virtual endpoint middleware).
