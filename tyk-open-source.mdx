...
import { GitHubStarButton } from '/snippets/GitHubStarButton.mdx';
...
<Card href="tyk-open-source#install-tyk-gateway-with-docker" img="/img/docker.png">
**Read time: 10 mins**

Install with Docker.
</Card>

<Card href="tyk-open-source#install-tyk-gateway-with-kubernetes" img="/img/k8s.png">
**Read time: 10 mins**

Install with K8s.
</Card>

<Card href="tyk-open-source#install-tyk-gateway-with-ansible" img="/img/ansible.png">
**Read time: 10 mins**

Install with Ansible.
</Card>

<Card href="tyk-open-source#install-tyk-gateway-on-red-hat-rhel--centos" img="/img/redhat-logo2.png">
**Read time: 10 mins**

Install on RHEL / CentOS.
</Card>

<Card href="tyk-open-source#install-tyk-gateway-with-ubuntu" img="/img/debian-nd-753.png">
**Read time: 10 mins**
