...
Use our [migration tool](/tyk-self-managed#migrating-from-an-existing-mongodb-instance) to manage the switch from MongoDB to SQL.
...
For full installation details, check the usual [installation page](/tyk-open-source#install-tyk-gateway-with-docker).
