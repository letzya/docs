...
<h4 id="dependencies-1.2">Dependencies</h4>
...
Go to the [Upgrading Tyk Operator](/api-management/automations/operator#install-and-configure-tyk-operator) section for detailed upgrade instructions.
...
<h4 id="Changelog-v1.2.0">Changelog</h4>
##### Added
...
<h4 id="dependencies-1.1">Dependencies</h4>
##### 3rd Party Dependencies & Tools
...
<h4 id="Changelog-v1.1.0">Changelog</h4>
##### Added
...
[Learn More](/api-management/automations/operator#create-a-tykstreamsapidefinition-custom-resource)
</Expandable>
</li>
</ul>
...
For details please refer to the [changelog](/#Changelog-v1.0.0) below.


<h4 id="breaking-changesv1.0.0">Breaking Changes</h4>
{/* Required. Use the following statement if there are no breaking changes, or explain if there are */}
{/* This release has no breaking changes. */}
**License Requirement:** Tyk Operator is now a closed-source product and requires a valid license key to operate. Please follow our [Installation and Upgrade Guide](/api-management/automations/operator#install-and-configure-tyk-operator) to set your license key before installation or upgrade.
...
Go to the [Upgrading Tyk Operator](/api-management/automations/operator#upgrading-tyk-operator) section for detailed upgrade instructions.
...
- [Docker image v1.0.0](https://hub.docker.com/r/tykio/tyk-operator/tags?page=&page_size=&ordering=&name=v1.0.0)
  - ```bash
    ...
    ```
- Helm chart
  - [tyk-charts v2.1.0](/developer-support/release-notes/helm-chart#210-release-notes) {/* This is the link to the Helm charts links. Please be mindful that this URL is only available a few hours or day/s after we release the main release, so this link needs to be updated in a separate iteration */}
{/* source code tarball for oss projects */}

<h4 id="Changelog-v1.0.0">Changelog</h4>
...
Learn More: [Create Tyk OAS API](/api-management/automations/operator#set-up-tyk-oas-api)
</Accordion>
...
Learn More: [Tyk Ingress Controller](/api-management/automations/operator#control-kubernetes-ingress-resources)
</Accordion>
...
Learn More: [Key-Level Per-API Rate Limits and Quota](/api-management/automations/operator#security-policy-example)
</Accordion>
...
Learn More: [Key-Level Per-Endpoint Rate Limits](/api-management/automations/operator#security-policy-example)
</Accordion>
...
Learn More: [TykOasApiDefinition in Security Policy](/api-management/automations/operator#add-a-security-policy-to-your-api)
</Accordion>
...
Learn More: [Event Webhook with Tyk Classic](/api-management/gateway-events#webhook-event-handlers-with-tyk-classic-apis)
</Accordion>
...
<ul>
<li>
<Expandable title={'Changelog item summary'}>
...
<li>
<Expandable title={'Another changelog item summary'}>
...
For details please refer to the [changelog](/#Changelog-v0.18.0) below.
...
- [introspection](/api-management/graphql#turning-off-introspection) option to enable/disable GraphQL introspection
- [graphql.proxy.auth_headers](/api-management/graphql#creating-a-graphql-api-via-the-dashboard-ui)
- [graphql.proxy.subscription_type](/api-management/graphql#graphql-subscriptions)
- [graphql.proxy.request_headers](/api-management/graphql#request-headers)
...
#### Release Highlights
This release is focused on bug fixes. For details please refer to the [changelog](/#Changelog-v0.17.1) below.
...
<h4 id="Changelog-v0.17.1">Changelog</h4>
##### Fixed
...
For details please refer to the [changelog](/#Changelog-v0.17.0) below.
...
<h4 id="Changelog-v0.17.0">Changelog</h4>
##### Fixed
...
#### Release Highlights
This release added support for analytics plugin, UDG global header, and detailed tracing setting in ApiDefinition as detailed in the [changelog](/#Changelog-v0.16.0) below.
