...
sidebarTitle: "Tyk Pump Release Notes"
...
<h4 id="Changelog-v1.11.2">Changelog</h4>
##### Fixed
...
<h4 id="Changelog-v1.11.1">Changelog</h4>
##### Changed
...
<h4 id="Changelog-v1.11.0">Changelog</h4>
##### Added
...
<h3 id="Changelog-v1.10.0">Changelog</h3>
#### Added
...
- When [`omit_configfile`](/tyk-pump/tyk-pump-configuration/tyk-pump-environment-variables.md#omit_config_file) is set to `true`, Pump will not try to load the config file and spit out error logs

##### Updated
- Updated the default Hybrid Pump RPC pool size from 20 to 5 connections in order to reduce default CPU and memory footprint. See [Pump configurations](/tyk-pump/tyk-pump-configuration/tyk-pump-environment-variables.md#pumpshybridmetarpcpoolsize)
