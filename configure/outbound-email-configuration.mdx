...
<iframe width="560" height="315" src="https://www.youtube.com/embed/XNyKRAlTDVs" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
1. Select **Settings** from your **Dashboard** > **Portal Management**
2. From the **Portal manager email address** section, enter the email address of the person responsible for approving your developer API subscription requests. See [Portal Key Requests](/tyk-developer-portal/tyk-portal-classic/portal-concepts#key-requests) for more details.
