...
## FAQs
 ...
 <summary><b>Can I create custom labels with my own predefined values?</b></summary>
...
<summary><b>How do labels differ from tags?</b></summary>
...
Labels are structured key-value pairs that can be validated and used for governance, while tags are typically simpler, unstructured text values used primarily for search.
 ...
 <summary><b>Are labels from source systems preserved during discovery?</b></summary>
...
## Troubleshooting
 ...
 <summary><b>Labels not appearing in filter options</b></summary>
...
- Refresh the browser cache if the label was recently added  
 ...
 <summary><b>Cannot add a specific label value</b></summary>
