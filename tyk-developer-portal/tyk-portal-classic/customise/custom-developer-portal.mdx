...
import PortalDeveloperAnalytics from '/snippets/portal-developer-analytics.mdx';
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/elrAEp1EZ_s" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
